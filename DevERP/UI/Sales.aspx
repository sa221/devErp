                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2 myTextBoxMar">
                                            <asp:Button ID="addButton" runat="server" class="btn btn-success myButtonTopMargin" Text="Add" OnClick="addButton_Click" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <div class="col-lg-12">
                                                ...
                                                <asp:GridView ID="salesGridView" runat="server" UseAccessibleHeader="true" ShowHeaderWhenEmpty="true"
                                                    OnSelectedIndexChanged="salesGridView_SelectedIndexChanged" OnRowDeleting="OnRowDeletingProduct" OnRowDataBound="ItemOnRowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ItemDiscountPer" HeaderText="I.Dis. %" />
                                                        <asp:BoundField DataField="ItemDiscountTk" HeaderText="I.Dis. TK" />
                                                        <asp:BoundField DataField="OfferDiscountPer" HeaderText="O.Dis. %" />
                                                        <asp:BoundField DataField="OfferDiscountTk" HeaderText="O.Dis. TK" />--%>
                                                        <asp:BoundField DataField="Total" HeaderText="Total Taka" />
                                                        ...
                                                        <%--<asp:CommandField
                                                            ...
                                                            DeleteImageUrl="~/Images/cross.png"/>--%>
                                                    </Columns>
